...
public class BetaUI extends JFrame
{
	...
	public void loadGame()
	{
		try
		{
			...
			// load defeated bosses list
			if (data.defeatedBosses != null)
			{
				defeatedBosses = new java.util.HashSet<>(data.defeatedBosses);
			}
			else
			{
				defeatedBosses = new java.util.HashSet<>();
			}
	...
	public void loadGameFromSlot(int slot)
	{
		try
		{
			...
			player.setHpUpgradeCount(data.hpUpgradeCount);
			...
			// restore the defeated bosses list
			if (data.defeatedBosses != null)
			{
				defeatedBosses = new java.util.HashSet<>(data.defeatedBosses);
			}
			...
			{
				defeatedBosses = new java.util.HashSet<>(); // safe fallback of
															// empty list
			}
